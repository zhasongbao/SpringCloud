package com.springboot.cloud.sysadmin.organization.util;
...
public class TreeUtil {
     ...
     * @return
     */
    public static List<SysResourceTree> list2Tree(List<Resource> sysResources, Integer root){
        // 普通对象转树节点
     ...
     * @return
     */
    public static List<SysResourceTree> buildTree(List<Resource> sysResources){
        List<SysResourceTree> trees = new ArrayList<>();
